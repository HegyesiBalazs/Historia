document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("elfelejtett-jelszo-form").addEventListener("submit", (e) => {
      ...
      const errorElement = document.getElementById("forgot-message-container");
      ...
      console.log("Email küldése folyamatban:", email);
      ...
      .then((data) => {
          ...
          if (data.sikeres) {
              ...
              // Űrlapok láthatóságának váltása
              document.getElementById("elfelejtett-jelszo-form").style.display = "none"; // Első űrlap elrejtése
              document.getElementById("uj-jelszo-form").style.display = "block"; // Második űrlap megjelenítése
          } else {
              errorElement.style.display = "block";
              errorElement.style.color = "red";
  ...
  document.getElementById("uj-jelszo-form").addEventListener("submit", (e) => {
      e.preventDefault();
      const errorElement = document.getElementById("forgot-message-container"); // Definiáljuk az errorElement-et
...
document.getElementById("change-email-form").addEventListener("submit", (e) => {
  ...
  .then((data) => {
      if (data.sikeres) {
          ...
          console.log("Űrlapok váltása: change-email-form elrejtése, verify-email-form megjelenítése"); // Naplózás
  ...
  document.getElementById("change-email-form").addEventListener("submit", (e) => {
      ...
      .then((response) => {
          // Nyers válasz naplózása
          return response.text().then((text) => {
              console.log("Nyers szerver válasz:", text);
              return JSON.parse(text); // JSON konvertálás
          });
      })
      .then((data) => {
          if (data.sikeres) {
              setSuccessMessage(changeEmailMessageContainer, "A kód elküldve az új email címedre!");
              console.log("Űrlapok váltása: change-email-form elrejtése, verify-email-form megjelenítése");
              document.getElementById("change-email-form").style.display = "none";
              const verifyEmailForm = document.getElementById("verify-email-form");
              verifyEmailForm.classList.add("visible");
              document.getElementById("verify-new-email").value = newEmail;
          } else {
              setErrorMessage(changeEmailMessageContainer, data.uzenet || "Hiba történt!");
          }
