...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Ápr 18. 10:23
...
--
-- Tábla szerkezet ehhez a táblához `email_hitelesites`
--
...
--
-- Tábla szerkezet ehhez a táblához `email_modositas_hitelesites`
--
...
CREATE TABLE `jelszomodosit` (
  ...
  `uj_jelszo` varchar(255) DEFAULT NULL,
...
--
-- A tábla indexei `email_hitelesites`
--
ALTER TABLE `email_hitelesites`
  ADD PRIMARY KEY (`id`),
  ADD KEY `email` (`email`);

--
-- A tábla indexei `email_modositas_hitelesites`
--
ALTER TABLE `email_modositas_hitelesites`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT a táblához `email_hitelesites`
--
ALTER TABLE `email_hitelesites`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT a táblához `email_modositas_hitelesites`
--
ALTER TABLE `email_modositas_hitelesites`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- Megkötések a táblához `email_hitelesites`
--
ALTER TABLE `email_hitelesites`
  ADD CONSTRAINT `email_hitelesites_ibfk_1` FOREIGN KEY (`email`) REFERENCES `regisztralas` (`email`);

--
-- Megkötések a táblához `email_modositas_hitelesites`
--
ALTER TABLE `email_modositas_hitelesites`
  ADD CONSTRAINT `email_modositas_hitelesites_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `regisztralas` (`id`);
...
--
-- Megkötések a táblához `jelszomodosit`
--
ALTER TABLE `jelszomodosit`
  ADD CONSTRAINT `jelszomodosit_ibfk_1` FOREIGN KEY (`reg_email`) REFERENCES `regisztralas` (`email`);
COMMIT;
